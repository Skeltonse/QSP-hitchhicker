...
QSP simulator for Unitary U and projector set P
"""
...
def VFINDER(P, Q):
    ...
    Returns
    V,Vd : [2, 2] numpy arrays; unitaries to act on the ancillary qubit for QSP
...
def COMPLEX_QSP_SIM(U, Plist, Qlist, E0, convent=np.array([[1], [1]])/np.sqrt(2), ):
    """
    The main function for computing QSP circuits as in https://quantum-journal.org/papers/q-2019-10-07-190/
...
def COMPLEX_QSP_SIM2(U, Plist, Qlist, E0, convent=np.array([[1], [1]], dtype=complex)/np.sqrt(2)):
    """
    Computing QSP circuits as in https://quantum-journal.org/papers/q-2019-10-07-190/
